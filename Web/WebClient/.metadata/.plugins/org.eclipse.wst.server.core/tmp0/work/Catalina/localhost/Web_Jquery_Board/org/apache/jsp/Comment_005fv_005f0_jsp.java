 ...
 * Generated at: 2023-06-05 07:23:17 UTC
...
public final class Comment_005fv_005f0_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	List<CommentVO> commentlist = dao.getCommentList(bbsSeq);
      ...
      out.write("					/*\r\n");
      out.write("					return false;는 이벤트 핸들러를 종료시키고, 이벤트의 기본 동작을 취소하는 역할을 합니다. \r\n");
      out.write("					이 경우에는 클릭 이벤트를 처리하는 핸들러 함수가 종료되며, false를 반환하므로 \r\n");
      out.write("					이벤트의 기본 동작(일반적으로는 폼 전송 등)이 발생하지 않게 됩니다. */\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("				//1. 조합문자열\r\n");
      ...
      out.write("				$.ajax(\r\n");
      out.write("						{\r\n");
      out.write("							url : \"CommentAdd_v_0.jsp\",\r\n");
      ...
      out.write("							{\r\n");
      out.write("								$('#container').html(htmldata); // 성공응답에서 받아온 데이터를 container안에 뿌려줌\r\n");
      out.write("								$('#comment').val(\"\"); // input 안 비워줌\r\n");
      out.write("							}\r\n");
      out.write("						}	\r\n");
      out.write("				      );\r\n");
      out.write("\r\n");
