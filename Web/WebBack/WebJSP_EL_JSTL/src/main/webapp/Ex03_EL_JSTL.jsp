...
------------------------------------------------------------<br>
 ...
 당신의 직업 : ${job} <br>
 만약에 당신이 include, forward 를 한다면 그 페이지에서도 jdb 이라는 값을 출력할 수 있다
 <br>
 ...
 잘쓰지 않아요 (재미로)<br>
<c:remove var="job2"/>
변수가 없어도 예외가 터지지 않아요. 그냥 값이 안나옴 : ${job2}
