...
public class BoardController {
	...
	//@Autowired
	private SqlSession sqlsession; // rootContext 에 있는 sqlSession객체 주소를 받나봄..
	@Autowired
	...
	public String list(Model model, String pg) {
		...
		// Mybatis >> DTO >> resultType="kr.co.mycom.model.BoardDTO"
		//10건의 데이터에 DTO 개 만들고 list 만들고 add 주소를 return ArrayList  add
